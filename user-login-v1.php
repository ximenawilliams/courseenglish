    ...
    <body class="account separate-inputs" data-page="login">
        ...
        <div class="container" id="login-block">
            <div class="row">
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <div class="account-wall">
                        ...
                        <form class="form-signin" action="login1.php" method="post" role="form">
                            <div class="append-icon">
                                <input type="text" name="name" id="name" class="form-control form-white username" placeholder="Username" required>
                                <i class="icon-user"></i>
                            </div>
                            <div class="append-icon m-b-20">
                                <input type="password" name="pwd" class="form-control form-white password" placeholder="Password" required>
                                <i class="icon-lock"></i>
                            </div>
            ...
            <p class="account-copyright">
                <span>Copyright © 2018 </span><span></span>.<span>All rights reserved.</span>
            </p>
