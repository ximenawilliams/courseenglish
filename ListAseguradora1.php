...
<html lang="en">
  <head>
    ...
    <title>Administrator Dr. Pocha</title>
      ...
      <div class="sidebar">
        ...
        <div class="sidebar-inner">
          <ul class="nav nav-sidebar">
            ...
            <li class="nav-parent">
              <a href="#"><i class="icon-puzzle"></i><span>Menu 1</span> <span class="fa arrow"></span></a>
            ...
            <li class="nav-parent">
              <a href=""><i class="icon-screen-desktop"></i><span>Menu</span> <span class="fa arrow"></span></a>
         
            </li>
            <li class="nav-parent">
              <a href=""><i class="icon-layers"></i><span>Menu</span><span class="fa arrow"></span></a>

            </li>
            <li class="nav-parent">
              <a href=""><i class="icon-note"></i><span>list </span><span class="fa arrow"></span></a>
   
            </li>
            <li class="nav-parent">
              <a href=""><i class="fa fa-table"></i><span>list 2</span><span class="fa arrow"></span></a>
...
?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="cerrar.php"><i class="icon-logout"></i><span>Logout</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
...
Curso de Ingles <br/>
<a title="Hogar ingles 1" href="WebForm1.php">
<img alt="" src="image/home.png" style="height: 60px; width: 60px" />
</a>
